...
require(tidyverse)
require(lubridate)
project_sdgs = readr::read_csv('1_Data/sdg_hackathon_data.zip')
```
...
```{r, echo = F, message=F}
require(tibble)
options(tibble.width = 35, tibble.max_extra_cols = 5, tibble.print_max = 3,
        tibble.print_min = 5)
```
...
```{r, message = F}
# Read in taxation
basel <- read_csv("1_Data/sdg_hackathon_data.zip")
...
```{r, echo = F, message=F}
require(tibble)
options(tibble.width = 35, tibble.max_extra_cols = 4, tibble.print_max = 5,
        tibble.print_min = 8)
```
...
```{r, echo = F, message=F}
require(tibble)
options(tibble.width = 35, tibble.max_extra_cols = 3, tibble.print_max = 6,
        tibble.print_min = 6)
```
...
<h1><a href="https://therbootcamp.github.io/SDGDataViz_2021Nov/_sessions/Wrangling/Wrangling_practical.html">Practical</a></h1>
