...
3. That worked. Now determine the number of projects per year by inserting a `group_by()` in between the `distinct()` and the `summarize()` functions with `year` as the grouping variable.
